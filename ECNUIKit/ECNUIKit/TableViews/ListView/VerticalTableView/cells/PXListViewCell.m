...
{
    return [self cellLoadedFromNibNamed:nibName bundle:[NSBundle mainBundle] reusableIdentifier:identifier];
}
...
//    [cellNib instantiateNibWithOwner:[NSBundle mainBundle] topLevelObjects:&objects];
...
- (void)setReusableIdentifier:(NSString *)reusableIdentifier{
