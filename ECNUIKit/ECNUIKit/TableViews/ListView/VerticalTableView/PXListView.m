...
//    [self class] contentSizeForFrameSize:frameSize horizontalScrollerClass:<#(nullable Class)#> verticalScrollerClass:<#(nullable Class)#> borderType:<#(NSBorderType)#> controlSize:<#(NSControlSize)#> scrollerStyle:<#(NSScrollerStyle)#>
