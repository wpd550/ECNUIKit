...
@implementation ECNHorizontalTableView
...
- (NSRect)contentViewRect
{
    ...
    NSSize availableSize1 = [[self class] contentSizeForFrameSize:frameSize horizontalScrollerClass:self.horizontalScroller.class verticalScrollerClass:self.verticalScroller.class borderType:[self borderType] controlSize:nil scrollerStyle:NSScrollerStyleOverlay];
