...
#define IKCOLORHEX(rgbValue)         ([NSColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0f green:((float)((rgbValue & 0xFF00) >> 8))/255.0f blue:((float)(rgbValue & 0xFF))/255.0f alpha:1.0])

#define IKButtonBackGroundNormalColor IKCOLORHEX(0x1890FF)
#define IKButtonBackGroundHighlightColor IKCOLORHEX(0x40A9FF)
#define IKButtomBackGroundClickColor IKCOLORHEX(0x096DD9)
